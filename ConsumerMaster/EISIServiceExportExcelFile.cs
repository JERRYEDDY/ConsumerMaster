    ...
    public class EISIServiceExportExcelFile
    {
        ...
        public Workbook CreateWorkbook(string tradingPartnerId)
        {
            ...
            try
            {
                ...
                DataTable rnDataTable = util.GetDataTable("SELECT name, npi_number, ma_number, first_name, last_name FROM RenderingProviders WHERE (npi_number IS NULL OR npi_number = '') ORDER BY last_name");
