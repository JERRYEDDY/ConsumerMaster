...
<%--                    <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" HeaderStyle-Width="50px" ItemStyle-Width="50px"/>--%>
                    ...
                    <FormTemplate>
                        <section class="form-group">
                            ...
                            <li>
                                ...
                                <telerik:RadTextBox ID="first_name" runat="server" Text='<%# Bind("consumer_first") %>' TabIndex="1" ToolTip="Required" />
            ...
            <ClientSettings AllowKeyboardNavigation="true" EnablePostBackOnRowClick="true">     <%--EnablePostBackOnRowClick="true"--%>
