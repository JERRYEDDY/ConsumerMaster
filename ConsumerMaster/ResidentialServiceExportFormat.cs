...
{
    [DelimitedRecord(",")]
    public class ResidentialServiceExportFormat
    {
        ...
        private readonly Dictionary<int, ServiceExportColumn> _columnNameList = new Dictionary<int, ServiceExportColumn>
        {
            ...
            {9, new ServiceExportColumn {Include=true,Name="units"} },
            {10, new ServiceExportColumn {Include=true,Name="manual_billable_rate"} },
            {11, new ServiceExportColumn {Include=true,Name="prior_authorization_number"} },
            {12, new ServiceExportColumn {Include=true,Name="referral_number"} },
            ...
            {21, new ServiceExportColumn {Include=true,Name="rendering_provider_taxonomy_code"} },
        };

        public string[] ColumnStrings;
        private readonly bool _includeHours = false;

        public ResidentialServiceExportFormat()
        {
            ColumnStrings = GetColumns();
        }

        public ResidentialServiceExportFormat(bool include)
        {
