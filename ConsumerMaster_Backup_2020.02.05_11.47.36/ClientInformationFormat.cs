...
{
    [DelimitedRecord(",")]
    public class ClientInformationFormat
    {
        private static readonly NLog.Logger Logger = NLog.LogManager.GetCurrentClassLogger();

        class ClientInformationColumn
        {
            public ClientInformationColumn(bool inc, string name)
            {
                Include = inc;
                Name = name;
            }
        ...
        Dictionary<int, ClientInformationColumn> _columnNameList = new Dictionary<int, ClientInformationColumn>();

        public string[] ColumnStrings;

        public ClientInformationFormat()
        {
            ...
            {
                _columnNameList.Add(index++, new ClientInformationColumn(true, cname));
            }
