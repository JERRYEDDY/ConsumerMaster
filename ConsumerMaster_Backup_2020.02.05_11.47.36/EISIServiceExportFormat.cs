...
namespace ConsumerMaster
{
    ...
    public class EISIServiceExportFormat
    {
        ...
        private readonly Dictionary<int, ServiceExportColumn> _columnNameList = new Dictionary<int, ServiceExportColumn>
        {
            ...
            {10, new ServiceExportColumn {Include=false,Name="hours"} },
            {11, new ServiceExportColumn {Include=true,Name="units"} },
            {12, new ServiceExportColumn {Include=true,Name="manual_billable_rate"} },
            {13, new ServiceExportColumn {Include=true,Name="prior_authorization_number"} },
            {14, new ServiceExportColumn {Include=true,Name="referral_number"} },
            {15, new ServiceExportColumn {Include=true,Name="referring_provider_id"} },
            {16, new ServiceExportColumn {Include=true,Name="referring_provider_first_name"} },
            {17, new ServiceExportColumn {Include=true,Name="referring_provider_last_name"} },
            {18, new ServiceExportColumn {Include=true,Name="rendering_names"} },
            {19, new ServiceExportColumn {Include=true,Name="rendering_provider_id"} },
            {20, new ServiceExportColumn {Include=true,Name="rendering_provider_secondary_id"} },
            {21, new ServiceExportColumn {Include=true,Name="rendering_provider_first_name"} },
            {22, new ServiceExportColumn {Include=true,Name="rendering_provider_last_name"} },
            {23, new ServiceExportColumn {Include=true,Name="rendering_provider_taxonomy_code"} },
        };
